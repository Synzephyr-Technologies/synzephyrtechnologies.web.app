...
export function Hero() {
    ...
    return (
        <section className="relative flex flex-col items-center justify-center min-h-[95vh] overflow-hidden mesh-bg pt-20 pb-16 text-center md:pt-32 md:pb-32">
                ...
                >
                    ...
                    >
                        ...
                        <picture className="relative z-10 block animate-float">
                            <source
                                srcSet="/logo-300.webp 300w, /logo-640.webp 640w"
                    ...
                    <motion.p 
                        ...
                        className="mx-auto max-w-175 text-muted-foreground text-lg md:text-xl leading-relaxed"
                    >
            ...
            {/* Background elements */}
            <div 
                className="absolute top-1/4 left-1/4 w-125 h-125 bg-blue-500/10 blur-[120px] rounded-full pointer-events-none animate-pulse-slow" 
                aria-hidden="true" 
            />
            <div 
                className="absolute bottom-1/4 right-1/4 w-100 h-100 bg-cyan-500/10 blur-[100px] rounded-full pointer-events-none animate-pulse-slower" 
                aria-hidden="true" 
            />
