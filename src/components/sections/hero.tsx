    ...
    return (
        <section className="relative flex flex-col items-center justify-center min-h-[95vh] overflow-hidden mesh-bg pt-20 pb-16 text-center md:pt-32 md:pb-32">
            <div className="container relative z-10 px-4 md:px-6">
                ...
                >
                    ...
                    <motion.h1 
                        ...
                        className="text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl lg:text-8xl pb-2 leading-tight"
                    >
            ...
            <motion.div 
                ...
                className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-blue-500/10 blur-[120px] rounded-full pointer-events-none" 
                aria-hidden="true" 
            />
            <motion.div 
                animate={{ scale: [1.2, 1, 1.2], opacity: [0.3, 0.5, 0.3] }}
                transition={{ duration: 10, repeat: Infinity, ease: "easeInOut", delay: 2 }}
                className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-cyan-500/10 blur-[100px] rounded-full pointer-events-none" 
                aria-hidden="true" 
            />
